...
import { DisplayTitle, Title, Paragraph, Button, MiniTag, Comment, TextLink, DropButton } from '../components';
...
const InitiativesCardDetails = (props) => {
	...
	const destructureData = () => {
		if (initiative) {
			...
			const { id, name, description, User, dateCreated, dateEnd, dateMeeting, likes } = Post;
					...
					<div className="content-wrapper">
						...
						<div className="initiativeDetails__header">
							...
							<div className="initiativeDetails__icons">
								...
								<DropButton width="34" fill={theme.blue} initiativeId={id} userId={User} />
							</div>
						</div>
