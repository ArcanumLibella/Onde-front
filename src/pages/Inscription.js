...
import { DisplayTitle, Paragraph, TextLink, InputText, ImageWrapper } from '../components';
...
const Inscription = () => {
	...
	const createUser = (e) => {
		...
		if (form['password'].value === form['password_confirm'].value) {
			...
			Axios.post('https://onde-api.frb.io/api/users', {
				...
				<div className="content-wrapper">
					<div className="inscription__form">
						...
						>
							...
							<input className="form__button" type="submit" value="Confirmer l'inscription" />
						</form>
					</div>
				</div>
