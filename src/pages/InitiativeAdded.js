	...
	return (
		<InitiativeAddedStyled className="initiativeAdded">
			<div className="content-wrapper">
				...
				<DisplayTitle /* tag="h1" */>Votre initiative est créée !</DisplayTitle>
				<Paragraph>Vous pouvez la retrouver dans votre bibliothèque ou en effectuant une recherche !</Paragraph>
