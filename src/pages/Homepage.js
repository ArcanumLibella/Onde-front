			...
			<section className="section section--advantages section--darkBlue">
				<div className="content-wrapper">
					<div className="section__wrapper">
						...
						<ImageWrapper name="SecurityCheck" alt="Vérification de la sécurité" />
					</div>
				</div>
			</section>
			...
			<section className="section section--features">
				<div className="content-wrapper">
					<div className="feature">
						...
						<ImageWrapper name="GirlReceivingNotification" alt="Fille recevant des notifications" />
					</div>
					<div className="feature">
						<div className="feature__text">
						...
						<ImageWrapper name="BoyUnderneathFirework" alt="Garçon sous un feu d'artifice" />
					</div>
					<div className="feature">
						<div className="feature__text">
						...
						<ImageWrapper name="GuysAndChatBubbles" alt="Personnes qui discutent" />
					</div>
				</div>
			</section>
