...
const InitiativeCreate = (props) => {
    ...
    const getTags = () => {
        Axios.get('https://onde-api.frb.io/api/tags').then((response => {setTags(response.data['hydra:member']); console.log(response.data['hydra:member']);}));
    }

    const getDepartements = () => {
        Axios.get('https://onde-api.frb.io/api/departments').then((response => {setDepartements(response.data['hydra:member']); console.log(response.data['hydra:member']); }));
    }
	...
	return (
		<div>
            <form onSubmit={(e) => { createInitiative(e) }}>
