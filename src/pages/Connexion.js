...
import { DisplayTitle, InputText, ImageWrapper, Paragraph, } from '../components'
    ...
    <ConnexionStyled>
      <div className="sections">
          <div className="content-wrapper section">
            <div>
              <DisplayTitle fontSize="30" fontWeight="800" >Heureux de vous retrouver !</DisplayTitle>
              <Link to="/inscription"><Paragraph fontSize={rem(16)}>Pas encore de compte ?</Paragraph></Link>
